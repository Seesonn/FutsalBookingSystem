...
export default function BookingSlot() {
  ...
  return (
    <div className=" mini-h-screen bg-white bg-opacity-20 backdrop-blur-lg p-4 sm:p-8 md:p-12 rounded-lg shadow-[0_0_20px_rgba(255,255,255,0.15)] overflow-hidden relative">
